...
public class CorsoDAO {
	...
	public Map<Corso, Integer> getIscrittiByPeriodo(Integer pd) {
		String sql = "SELECT c.codins, c.nome, c.crediti, c.pd, COUNT(*) AS tot FROM corso AS c, iscrizione AS i WHERE c.pd = ? AND c.codins=i.codins GROUP BY c.codins, c.nome, c.crediti, c.pd";
